...
path_results <- file.path("inst", "shiny-examples", "BCGcalc", "results")
...
path_shiny <- file.path("inst", "app", "MNcalc")
fn_copy    <- "remove.txt"
...
myPkg <- "MNcalc"
#
# **app only don't need this section**
#
# # Load Library
# library(devtools)
# #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
