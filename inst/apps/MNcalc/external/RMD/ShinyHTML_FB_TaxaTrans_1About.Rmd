...
border_big = fp_border_default(color="black", width = 2)
border_small = fp_border_default(color="darkgray", width = 1)
flextable(df) |>
  autofit() |>
  border_remove() |>
  border_inner_h(part = "all", border = border_small) |>
  border_inner_v(part = "all", border = border_small) |>
  border_outer(part = "all", border = border_big) |>
  align(align = c("left", rep_len("center", ncol(df)-1))) |>
  bold(part = "header")
```
